...
This is the AutoRest configuration file for tianennewpubadvisor.
...
These are the global settings for the tianennewpubadvisor.

```yaml
openapi-type: arm
tag: package-2020-11-12
```

### Tag: package-2020-11-12

These settings apply only when `--tag=package-2020-11-12` is specified on the command line.

```yaml $(tag) == 'package-2020-11-12'
input-file:
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-js
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianennewpubadvisor']
  - repo: azure-resource-manager-schemas
    after_scripts:
      - node sdkauto_afterscript.js tianennewpubadvisor/resource-manager
```
