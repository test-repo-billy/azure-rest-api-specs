...
data "azapi_resource_id" "objectDataType" {
  type      = "Microsoft.Automation/automationAccounts/modules/objectDataTypes@2023-12-12"
  parent_id = azapi_resource.module.id
  name      = var.resource_name
}

data "azapi_resource_action" "fields" {
  type        = "Microsoft.Automation/automationAccounts/modules/objectDataTypes@2022-08-08"
