...
data "azapi_resource" "stream" {
  type      = "Microsoft.Automation/automationAccounts/runbooks/draft/streams@2022-08-08"
  parent_id = azapi_resource_action.draft.id
  name      = var.resource_name
}

data "azapi_resource_list" "listStreamsByDraft" {
  type       = "Microsoft.Automation/automationAccounts/runbooks/draft/streams@2022-08-08"
  parent_id  = azapi_resource_action.draft.id
