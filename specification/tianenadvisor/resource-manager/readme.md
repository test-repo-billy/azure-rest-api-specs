...
These settings apply only when `--tag=package-2021-03-04` is specified on the command line.

```yaml $(tag) == 'package-2021-03-04'
input-file:
...
swagger-to-sdk:
  ...
  - repo: azure-resource-manager-schemas
    after_scripts:
      - node sdkauto_afterscript.js tianenadvisor/resource-manager
