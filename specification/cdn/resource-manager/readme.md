...
openapi-type: arm
tag: package-preview-121213123123
```


### Tag: package-preview-121213123123

These settings apply only when `--tag=package-preview-121213123123` is specified on the command line.

```yaml $(tag) == 'package-preview-121213123123'
input-file:
  - Microsoft.Cdn/preview/121213123123/cdn.json
```
### Tag: package-2019-12
