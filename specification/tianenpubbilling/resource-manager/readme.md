...
This is the AutoRest configuration file for tianenpubbilling.
...
These are the global settings for the tianenpubbilling.

```yaml
openapi-type: arm
tag: package-2020-11-13
```

### Tag: package-2020-11-13

These settings apply only when `--tag=package-2020-11-13` is specified on the command line.

```yaml $(tag) == 'package-2020-11-13'
input-file:
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-js
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianenpubbilling']
  - repo: azure-resource-manager-schemas
    after_scripts:
      - node sdkauto_afterscript.js tianenpubbilling/resource-manager
```
