...
``` yaml
openapi-type: arm
tag: package-preview-1991-01
```


### Tag: package-preview-1991-01

These settings apply only when `--tag=package-preview-1991-01` is specified on the command line.

```yaml $(tag) == 'package-preview-1991-01'
input-file:
  - Microsoft.Addons/preview/1991-01-01/addons-swagger.json
```
### Tag: package-2018-03
